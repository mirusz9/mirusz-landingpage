				...
				<div id="rightContentWrapper">
					<div id="rightContent" ref={rightContentRef}>
						...
						<section>
							...
							<p>
								Here are the highlights of my many coding projects. Note that all of these (and many more projects that I
								did not include on this website) are available on my{' '}
						...
						<section className="secondary">
							...
							<p>
								Understanding the IB and AP systems was a real challenge for me as our family had no previous experience
								with these programs. We had to figure out all the requirements from a 100-page document. As this process was
								overwhelming for many students, I came up with the idea to create a schedule planner for my school. This
								website aimed to explain how the AP, IB, and credit systems work, what classes one needs to graduate, and
						...
						<section className="secondary">
							...
							<p>
								...
								on YouTube. It is based on an SIR model that can be customized with many settings such as the rate of spread
								of the virus, the percentage of the population following social distancing rules, or the duration for which
								a cell is infectious.
							</p>
							<p>
						...
						<section className="secondary">
							...
							<p>
								Me and three of my classmates partnered up to compete in the High School Mathematical Contest in Modeling,
								where we had to create a model that reflects the population size of a bee colony over time. The twenty-four
